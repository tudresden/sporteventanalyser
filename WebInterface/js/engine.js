...
(function() {
  var ANIM_FACTOR, BALL_SIZE, Ball, Drawable, Engine, FIELD_HEIGHT, FIELD_HEIGHT2, FIELD_WIDTH, FIELD_WIDTH2, Field, Moveable, PI2, PLAYER_SIZE, PLAYER_SIZE2, Player, SELECT_SIZE, add_player, ball, comment, compose_stats_tbody, engine, establish_sea_connection, observed_player_a, observed_player_b, playersdict, refresh_selection, replace_img_by_svg, run, running, t, team_a_stats, team_b_stats, teams, tmp_counter, tmp_team_name, translation_dict, update_commentator, update_position, update_statistics,
  ...
  update_commentator = function(v) {
    ...
    switch (v.constructor.name) {
      case "CurrentPrognosisData":
        ...
        break;
      default:
        return console.log("unknown type of prediction: ", v);
    }
  };
