...
(function() {
  var Ball, Drawable, Engine, FIELD_HEIGHT, FIELD_WIDTH, Field, Moveable, PI2, Player, add_player, ball, engine, establish_sea_connection, playersdict, refresh_selection, run, running, tmp_counter, tmp_team_name, update_position,
