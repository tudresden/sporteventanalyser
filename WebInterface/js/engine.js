...
(function() {
  ...
  update_heatmap = function(item) {
    if (observed_player_a || observed_player_b) {
      ...
      return console.log(item.teamHeatMaps);
    }
  };
