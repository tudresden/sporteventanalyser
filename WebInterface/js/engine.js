...
(function() {
  var ANIM_FACTOR, BALL_SIZE, Ball, Drawable, Engine, FIELD_HEIGHT, FIELD_HEIGHT2, FIELD_WIDTH, FIELD_WIDTH2, Field, Moveable, PI2, PLAYER_SIZE, PLAYER_SIZE2, Player, SELECT_SIZE, add_player, ball, compose_stats_tbody, engine, establish_sea_connection, observed_player_a, observed_player_b, playersdict, refresh_selection, run, running, t, team_a_stats, team_b_stats, tmp_counter, tmp_team_name, translation_dict, update_position, update_statistics,
  ...
  refresh_selection = function(event, ui) {
    var a_plr, a_stats, all_plrs, b_plr, b_stats, plr_ids_a, plr_ids_b, _ref, _ref1, _ref2, _ref3;
    ...
    if (plr_ids_a.length) {
      ...
      a_stats.find("tbody").replaceWith(compose_stats_tbody((_ref1 = playersdict[plr_ids_a[0]]) != null ? _ref1.stats : void 0));
    } else {
    ...
    if (plr_ids_b.length) {
      ...
      b_stats.find(".player_name").text((_ref2 = playersdict[plr_ids_b[0]]) != null ? _ref2.name : void 0);
      b_stats.find("tbody").replaceWith(compose_stats_tbody((_ref3 = playersdict[plr_ids_b[0]]) != null ? _ref3.stats : void 0));
    } else {
