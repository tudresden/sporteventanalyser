...
(function() {
  var Ball, Drawable, Engine, Field, Moveable, Player, add_player, ball, engine, establish_sea_connection, playersdict, refresh_selection, run, running, tmp_counter, tmp_team_name, update_position,
    ...
    Engine.prototype.render = function() {
      ...
      switch (this.camera_mode) {
        case "BIRD":
          ...
          break;
        case "KEEPERA":
          this.camera.position.set(-60, 6, 0);
  ...
  Field = (function(_super) {
    ...
    function Field(texturefile, reality) {
      ...
      this.field.rotation.set(-Math.PI / 2, 0, 0);
