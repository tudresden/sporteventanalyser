...
public class OutElementXS extends XMPPBean {
	...
	public OutElementXS buildInFaultSimple(String detailedErrorText){
		OutElementXS fault = ( OutElementXS )this.clone();

		fault.setTo( this.getFrom() );
    	fault.setId(this.getId());
		fault.setType( XMPPBean.TYPE_ERROR );
		fault.errorType = "modify";
		fault.errorCondition = "bad-request";
		fault.errorText = "Fault incoming";
