...
public class OutComplexFull implements XMPPInfo {
	...
	private OutComplexXS outVal = new OutComplexXS();


	public OutComplexFull( int intVal, long longVal, boolean booleanVal, double doubleVal, float floatVal, byte byteVal, short shortVal, String stringVal, OutComplexXS outVal ) {
		super();
		this.intVal = intVal;
	...
	public void fromXML( XmlPullParser parser ) throws Exception {
		...
		do {
			...
			case XmlPullParser.START_TAG:
				...
				else if (tagName.equals( OutComplexXS.CHILD_ELEMENT ) ) {
					this.outVal.fromXML( parser );
				}
				else
					parser.next();
				break;
	...
	public static final String CHILD_ELEMENT = "OutComplexFull";
	...
	public static final String NAMESPACE = "http://mobilis.inf.tu-dresden.de#services/XSLTTestService#type:OutComplexFull";
	...
	public String toXML() {
		...
		sb.append( "<" + this.outVal.getChildElement() + ">" )
			.append( this.outVal.toXML() )
			.append( "</" + this.outVal.getChildElement() + ">" );
	...
	public OutComplexXS getOutVal() {
		return this.outVal;
	}

	public void setOutVal( OutComplexXS outVal ) {
		this.outVal = outVal;
	}
